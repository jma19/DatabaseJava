...
public class QueryPlanTest {
  ...
  public void setUp() throws DatabaseException, IOException {
    ...
    for (int i = 0; i < defaultNumRecords; i++) {
      ...
      IntDataField intValue = new IntDataField(this.random.nextInt());
      FloatDataField floatValue = new FloatDataField(this.random.nextFloat());
      BoolDataFiled boolValue = new BoolDataFiled(this.random.nextBoolean());
      String stringValue = "";
      ...
      values.add(intValue);
      values.add(new StringDataField(stringValue, 5));
  ...
  public void testSimpleSelect() throws DatabaseException, QueryPlanException {
    ...
    while (outputIterator.hasNext()) {
      ...
      assertTrue(record.getValues().get(0) instanceof IntDataField);
      assertTrue(record.getValues().get(1) instanceof StringDataField);
  ...
  public void testSimpleWhere() throws DatabaseException, QueryPlanException {
    ...
    queryPlan.where("int", QueryPlan.PredicateOperator.GREATER_THAN_EQUALS, new IntDataField(0));
  ...
  public void testSimpleGroupBy() throws DatabaseException, QueryPlanException {
    ...
    while (outputIterator.hasNext()) {
      ...
      if (first) {
        ...
        Assert.assertEquals(prevValue, record.getValues().get(1).getInt());
      }
    }
  ...
  public void testSimpleJoin() throws DatabaseException, QueryPlanException {
    ...
    while (outputIterator.hasNext()) {
      ...
      Record record = outputIterator.next();
      List<DataFiled> recordValues = record.getValues();
  ...
  public void testSelectWhere() throws DatabaseException, QueryPlanException {
    ...
    while (recordIterator.hasNext()) {
      ...
      assertTrue(values.get(0) instanceof BoolDataFiled);
      assertTrue(values.get(1) instanceof IntDataField);
  ...
  public void testSelectJoin() throws DatabaseException, QueryPlanException {
    ...
    while (recordIterator.hasNext()) {
      ...
      assertTrue(values.get(0) instanceof IntDataField);
      assertTrue(values.get(1) instanceof StringDataField);
  ...
  public void testWhereJoin() throws DatabaseException, QueryPlanException {
    ...
    queryPlan.where("t1.bool", QueryPlan.PredicateOperator.NOT_EQUALS, new BoolDataFiled(false));
  ...
  public void testSelectGroupBy() throws DatabaseException, QueryPlanException {
    ...
    while (recordIterator.hasNext()) {
      ...
      if (first) {
        ...
        Assert.assertEquals(prevValue, record.getValues().get(0).getInt());
        assertEquals(1, record.getValues().size());
      }
    }
  ...
  public void testWhereGroupBy() throws DatabaseException, QueryPlanException {
    ...
    queryPlan.groupBy("int");
    queryPlan.where("int", QueryPlan.PredicateOperator.GREATER_THAN, new IntDataField(10));
  ...
  public void testSelectWhereGroupByJoin() throws DatabaseException, QueryPlanException {
    ...
    queryPlan.where(this.defaulTableName + ".int", QueryPlan.PredicateOperator.GREATER_THAN, new IntDataField(10));
    List<String> columnNames = new ArrayList<String>();
  ...
  public void testEmptyWhereResult() throws DatabaseException, QueryPlanException {
    ...
    queryPlan.where("int", QueryPlan.PredicateOperator.GREATER_THAN_EQUALS,
        new IntDataField(Integer.MAX_VALUE));
  ...
  public void testEmptyJoinResult() throws DatabaseException, QueryPlanException {
    ...
    List<DataFiled> otherSchemaTypes = new ArrayList<DataFiled>();
    otherSchemaTypes.add(new IntDataField());
