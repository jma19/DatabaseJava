...
public class QueryPlan {
    ...
    private List<DataFiled> whereDataBoxes;
    ...
    public QueryPlan(Database.Transaction transaction, String startTableName) {
        ...
        this.whereDataBoxes = new ArrayList<DataFiled>();
     ...
     * @throws QueryPlanException
     */
    public void where(String column, PredicateOperator comparison, DataFiled value) throws QueryPlanException {
    ...
    private void addWheres() throws QueryPlanException, DatabaseException {
        ...
        for (String whereColumn : this.whereColumnNames) {
            ...
            DataFiled value = this.whereDataBoxes.get(index);
