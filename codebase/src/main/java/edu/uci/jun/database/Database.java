...
import edu.uci.jun.database.concurrency.LockManager;
...
public class Database {
  ...
  public class Transaction {
    ...
    public RecordID addRecord(String tableName, List<DataFiled> values) throws DatabaseException {
      assert(this.active);
    ...
    public void updateRecord(String tableName, List<DataFiled> values, RecordID rid) throws DatabaseException {
      assert(this.active);
      checkAndGrabExclusiveLock(tableName);
      Table tab = getTable(tableName);
